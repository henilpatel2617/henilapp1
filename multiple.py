...
diabetes_model = pickle.load(open('C:\SAV\diabetes_model.sav','rb'))
heart_diaseases_model = pickle.load(open("C:\SAV\heart_model.sav",'rb'))
parkinsons_model = pickle.load(open("C:\SAV\parkinson_data.sav",'rb'))
